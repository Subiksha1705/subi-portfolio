...
const MobileEducationCarousel = () => {
  const educationData = [
    {
      ...
      summary:
        "Comprehensive 5-year integrated master's program specializing in software systems with hands-on experience in full-stack development, AI/ML, and modern DevOps practices.",
      highlights: [
    ...
    },
    {
      ...
      summary:
        'Science stream education with Mathematics, Physics, Chemistry, and Computer Science, building strong analytical and technical foundation.',
      highlights: [
    ...
    },
    {
      ...
      location: 'Attur, Tamil Nadu',
      summary:
        'Foundational secondary education with balanced curriculum covering core subjects and early exposure to computer applications.',
      highlights: [
  ...
  return (
    ...
    >
      <MobileCarousel ariaLabel="Education" adaptiveHeight>
        {educationData.map((edu) => (
          <div key={edu.id} className="mobile-carousel-slide">
...
export default memo(MobileEducationCarousel);
